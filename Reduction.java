 ...
 * @author Toshiba
 */
public class Reduction extends Determinant{
    String x;
    ...
    x=x+("Here R1 is exchanged by R2")+"\n"+
     ...
     +" | "+AA_3);
       ...
       double var_2const=(A1/a12);
        ...
        x=x+("there exists an infinite solution")+"\n"+
     ...
     x=x+("Values of varibles:variable 1="+var1)+"\n"+
         ...
         double var3=(-a23/a22);
         double AAA2=A2/a22;
         x=x+("Varible 2 in terms of var3 is var2 =: "+AAA2+"+ 122("+var3+")var3");
         double var2=((a12*a23/a22*a11)-(a13/a11));
         double var2const=((A1/a11)-(a12*A2/a22*a11));
         x=x+("Varible 1 in terms of var3 is var1 =: "+var2+"var3 + ("+var2const+")");
     }
